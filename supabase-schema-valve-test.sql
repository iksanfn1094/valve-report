...
shell_pressure_psi numeric,
  ...
  shell_acceptance text,
  shell_start_test text,
  shell_finish_test text,
  shell_result text,
  shell_remark text,
  shell_test_i_pressure_psi numeric,
  shell_test_i_duration_min numeric,
  shell_test_i_acceptance text,
  shell_test_i_start_test text,
  shell_test_i_finish_test text,
  shell_test_i_result text,
  shell_test_i_remark text,
  shell_test_ii_pressure_psi numeric,
  shell_test_ii_duration_min numeric,
  shell_test_ii_acceptance text,
  shell_test_ii_start_test text,
  shell_test_ii_finish_test text,
  shell_test_ii_result text,
  shell_test_ii_remark text,
  ...
  func100_remark text,
  -- Meta
  test_rows text default '[]',
  test_photos text default '[]',
...
ALTER TABLE report_valve_test ADD COLUMN IF NOT EXISTS test_photos text default '[]';
